...
The manuscript can be read **in html format** (webpage) at the following URL: <https://betsaka.github.io/population_near_protected_areas/Population_10km_PAs_dev_countries_2000-2020.html>

It is available in docx format (microsoft word) at the following URL: <https://betsaka.github.io/population_near_protected_areas/Population_10km_PAs_dev_countries_2000-2020.docx>

It is available in pdf format (Typst pdf output) at the following URL: <https://betsaka.github.io/population_near_protected_areas/Population_10km_PAs_dev_countries_2000-2020.pdf>

...
Main paper: [webpage](../docs/index.html) and [PDF](../manuscript/main.pdf). DOI: [10.1088/1748-9326/ae97f9](https://doi.org/10.1088/1748-9326/ae97f9).
...
# Read the table
table_s1 <- readRDS("../results/tables/table_s1.rds")
...
table_s2 <- readRDS("../results/tables/table_s2.rds")
drop_title(table_s2)
```
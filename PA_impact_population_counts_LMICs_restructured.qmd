...
To assess the consistency of GHSL and WorldPop population estimates, we compared values per country and year. We used the Standardized Mean Difference (SMD), which standardizes the difference by accounting for variations in scale and dispersion. It is computed as:

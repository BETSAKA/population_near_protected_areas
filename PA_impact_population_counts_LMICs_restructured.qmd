...
Table 1 presents the aggregate population counts inside protected areas and within 10 km of their boundaries in 2020, for all PAs present in the May 2021 WDPA release (including those with missing designation year), across the 75 LMICs included in the analysis.
...
In 2020, an estimated `r round(t1("2020 (all PAs)", "All LMICs excl. India", pop_in_all_m), 1)` million people lived inside protected areas across the 75 LMICs, while `r round(t1("2020 (all PAs)", "All LMICs excl. India", pop_10k_all_m), 1)` million lived inside or within 10 km of their boundaries, representing `r round(t1("2020 (all PAs)", "All LMICs excl. India", pct_10k_all), 1)`% of the population of these countries. For comparison, in 2000 (restricted to PAs with confirmed designation years), `r round(t1("2000 (confirmed)", "All LMICs excl. India", pop_in_all_m), 1)` million people lived inside PAs and `r round(t1("2000 (confirmed)", "All LMICs excl. India", pop_10k_all_m), 1)` million inside or within 10 km, representing `r round(t1("2000 (confirmed)", "All LMICs excl. India", pct_10k_all), 1)`% of the population.

The decomposition by PA category (Figure 1) reveals that the population adjacent to non-strict protected areas (IUCN IV-VI) and PAs whose IUCN category is not recorded substantially exceeds that adjacent to strict PAs (IUCN Ia-III). In 2020, populations inside or within 10 km of non-strict PAs (`r format(round(t1("2020 (all PAs)", "All LMICs excl. India", pop_10k_nonstrict_m), 0), big.mark = ",")` million) and unrecorded-category PAs (`r format(round(t1("2020 (all PAs)", "All LMICs excl. India", pop_10k_unknowncat_m), 0), big.mark = ",")` million) each exceeded those near strict PAs (`r format(round(t1("2020 (all PAs)", "All LMICs excl. India", pop_10k_strict_m), 0), big.mark = ",")` million). This pattern holds for populations inside PAs as well.
...
To connect our estimates to the impact evaluation literature, Table 2 translates common spatial exposure definitions into population orders of magnitude, using all 2020 PA boundaries (including those with missing designation year) and GHSL population estimates for the 75 LMICs.
...
![](results/figure_3.png){#fig-figure_3}
...
The decomposition by IUCN management category reveals that the majority of the population living near protected areas is adjacent to non-strict PAs (IUCN IV-VI) or PAs whose IUCN category is unrecorded in the WDPA, rather than the strict protection regimes (IUCN Ia-III) most commonly associated with access restrictions and displacement. This pattern held in both 2000 and 2020.
...
Across 75 low- and lower-middle-income countries, protected areas are adjacent to populations on the order of several hundred million people. Among PAs with recorded designation years, these figures are substantially larger in 2020 than in 2000, reflecting both PA expansion and population increase -- though incomplete temporal metadata in the WDPA means that the precise magnitude of this change cannot be established with certainty. The majority of these populations lives near non-strict protected areas or PAs whose IUCN management category is unrecorded, rather than the strict protection regimes most commonly studied in the impact evaluation literature. India, the largest LMIC by population, had to be excluded because its national PA data are absent from the WDPA -- a data gap that, if resolved, would substantially increase global estimates of PA-adjacent populations.
